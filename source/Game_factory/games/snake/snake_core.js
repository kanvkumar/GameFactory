...
var lvl_height = 20;
var speed = 20;
var body_count=1,food_count=1;
snakeHeadImage = new Image();
snakeHeadImage.src = "resources/head.png";
snakeBodyImage = new Image();
//snakeBodyImage.src = "resources/d1.jpg";
//snackBodyImage.src="resources/body"+i+".png";
snakeTailImage = new Image();
snakeTailImage.src = "resources/tail.png";
//food
//var Food=new Array(16);

foodImage = new Image();
foodImage.src = "resources/body.png";
create_snake();
create_food();
...
function animate() 
{
	...
	if(game_over == false)
	{
		...
		displayText("Score: " + (snakeLen - 2));
		display();
	}
	else
	{
		displayText("                            Game Over Buddy!");
	}
...
function display()
{
	...
	for(var i = 0; i < snakeLen; i++)
	{
		...
		{
                         snakeBodyImage.src= "resources/d"+(i-1)+".jpg"   
                  //       snakeBodyImage.src = "resources/d"+body_count.toString()+".jpg";
                    //     console.log(snakeBodyImage.src);
       ...
       // foodImage.src = "resources/d"+food_count.toString()+".jpg";
       foodImage.src = "resources/d"+i+".jpg";
